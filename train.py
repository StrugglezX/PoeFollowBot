...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='config/coco.data', help='*.data path')
    parser.add_argument('--multi-scale', action='store_true', help='adjust (67% - 150%) img_size every 10 batches')
    parser.add_argument('--img-size', nargs='+', type=int, default=[800], help='train and test image-sizes')
    ...
    parser.add_argument('--weights', type=str, default='config/yolov3.weights', help='initial weights')
